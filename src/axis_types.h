...
//  导航模式（全局设置）
// ═════════════════════════════════════════════════
enum AxisNavMode : uint8_t {
    AXIS_NAVMODE_JOYSTICK = 0,  // 离散方向键跳跃
    AXIS_NAVMODE_CURSOR   = 1,  // 连续光标 + 吸附
};

// ═════════════════════════════════════════════════
//  屏幕导航类型（每屏独立设置）
// ═════════════════════════════════════════════════
enum AxisNavType : uint8_t {
    AXIS_NAVTYPE_AUTO     = 0,  // 跟随全局 NavMode
    AXIS_NAVTYPE_DISCRETE = 1,  // 强制离散（列表页）
    AXIS_NAVTYPE_SPATIAL  = 2,  // 强制空间光标（节点图）
};
